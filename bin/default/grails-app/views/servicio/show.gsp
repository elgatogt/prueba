...
<html>
    ...
    <body>
        ...
        <div id="show-servicio" class="content scaffold-show" role="main">
            ...
            <f:display bean="servicio" />
            <g:form resource="${this.servicio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.servicio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
