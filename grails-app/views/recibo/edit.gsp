...
<html>
    ...
    <body>
        ...
        <div id="edit-recibo" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.recibo}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.recibo}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.recibo}" method="PUT">
                <g:hiddenField name="version" value="${this.recibo?.version}" />
                <fieldset class="form">
                    <f:all bean="recibo"/>
                </fieldset>
