...
<html>
    ...
    <body>
        ...
        <div id="show-recibo" class="content scaffold-show" role="main">
            ...
            <f:display bean="recibo" />
            <g:form resource="${this.recibo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.recibo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
