...
<html>
    ...
    <body>
        ...
        <div id="show-equipo" class="content scaffold-show" role="main">
            ...
            <f:display bean="equipo" />
            <g:form resource="${this.equipo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.equipo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
